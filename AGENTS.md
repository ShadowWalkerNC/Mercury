...
```
Project:      Mercury
Description:  Self-hosted communication platform. Spaces, channels, real-time messaging, web-first.
Status:       planning
...
```
Language:     Detected: Node.js/TypeScript · Docker
...
---
*Auto-generated: 2026-07-22 | Extends: ShadowWalkerNC/.github/AGENTS.md | Repo: [Mercury](https://github.com/ShadowWalkerNC/Mercury)*
